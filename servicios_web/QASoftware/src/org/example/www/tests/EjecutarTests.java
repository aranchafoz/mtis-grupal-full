 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static EjecutarTests parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EjecutarTests object =
                new EjecutarTests();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ejecutarTests".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EjecutarTests)org.example.www.tests.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
