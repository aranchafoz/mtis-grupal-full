 ...
 */
            ...
            /**
            *  RecibirPeticion bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RecibirPeticion
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.example.org/peticiones/",
                "recibirPeticion",
                "ns1");
                        ...
                        */
                                    ...
                                    protected java.lang.String localIdPeticion ;
                           ...
                           */
                           public  java.lang.String getIdPeticion(){
                            ...
                            /**
                               ...
                               */
                               public void setIdPeticion(java.lang.String param){
                        ...
                        */
                                    ...
                                    protected java.lang.String localLenguaje ;
                           ...
                           */
                           public  java.lang.String getLenguaje(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Lenguaje
                               */
                               public void setLenguaje(java.lang.String param){
                            
                                            this.localLenguaje=param;
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://www.example.org/peticiones/");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":recibirPeticion",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "recibirPeticion",
                           xmlWriter);
                                    ...
                                    writeStartElement(null, namespace, "idPeticion", xmlWriter);
                                          ...
                                          if (localIdPeticion==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localIdPeticion);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "lenguaje", xmlWriter);
                             

                                          if (localLenguaje==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("lenguaje cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localLenguaje);
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://www.example.org/peticiones/")){
                return "ns1";
            }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localIdPeticion != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIdPeticion));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("idPeticion cannot be null!!");
                                        }
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localLenguaje != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLenguaje));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("lenguaje cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static RecibirPeticion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RecibirPeticion object =
                new RecibirPeticion();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"recibirPeticion".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RecibirPeticion)org.example.www.peticiones.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","idPeticion").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","lenguaje").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"lenguaje" +"  cannot be null");
                                    }
